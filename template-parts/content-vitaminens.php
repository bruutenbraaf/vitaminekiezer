<div class="ingredient junior">
    ...
    <ul>
        ...
        <?php if (get_field('vitamine_b3') != "-" && get_field('vitamine_b3_w') != "-") { ?><li>
                <div class="row">
        ...
        <?php if (get_field('vitamine_b5') != "-" && get_field('vitamine_b5_w') != "-") { ?><li>
                <div class="row">
        ...
        <?php if (get_field('vitamine_b6') != "-" && get_field('vitamine_b6_w') != "-") { ?><li>
                <div class="row">
        ...
        <?php if (get_field('vitamine_b8') != "-" && get_field('vitamine_b8_w') != "-") { ?><li>
                <div class="row">
        ...
        <?php if (get_field('vitamine_b11') != "-" && get_field('vitamine_b11_w') != "-") { ?><li>
                <div class="row">
        ...
        <?php if (get_field('vitamine_b12' && get_field('vitamine_b12_w') != "-") { ?><li>
                <div class="row">
        ...
        <?php if (get_field('vitamine_c') != "-" && get_field('vitamine_c_w') != "-") { ?><li>
                <div class="row">
        ...
        <?php if (get_field('vitamine_d') != "-" && get_field('vitamine_d_w') != "-") { ?><li>
                <div class="row">
        ...
        <?php if (get_field('vitamine_k') != "-" && get_field('vitamine_k_w') != "-") { ?><li>
                <div class="row">
