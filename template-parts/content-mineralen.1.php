<div class="ingredient junior">
    ...
    <ul>
        ...
        <?php } ?>
        <?php if (get_field('molybdeen_4_mcg')) { ?>
            <li>
                <div class="row">
